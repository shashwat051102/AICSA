...
Quiz_agent = Agent(
    role = "Quiz Maker",
    goal = """
    Based on the content provided in {extracted_text}, you have to create quiz questions.
    You can create quiz questions from any content, including text, PDF, and website content.
    ...
    """,
    backstory="A student is asking for help with quiz making. You are a quiz maker who can create quiz questions from any content, including text, PDF, and website content.",
